...
$(document).ready(function() {
   ...
   $(document).on('click', '#tableid td #ordercarticon', function() {
	...
	$('#detailcheckbox').on('click',function(){
		$('#ordernameCss').val($("#originName").text());
		$('#orderaddressCss').val($("#originZipcode").text());
		$('#orderaddressCss2').val($("#originAddress").text());
		$('#orderaddressCss3').val($("#originDetailAddress").text());	
		$('#orderphoneCss').val($("#originPhone1").text());
		$('#orderphoneCss2').val($("#originPhone2").text());
		$('#orderphoneCss3').val($("#originPhone3").text());	
		$('#orderemailCss').val($("#originEmail").text());
   	});
